/**
 * Codex-Arctic Bridge Prompt
 *
 * This prompt bridges Codex CLI instructions to the Arctic environment.
 ...
 *
 * Token Count: ~450 tokens (~90% reduction vs full Arctic prompt)
 */

export const CODEX_OPENCODE_BRIDGE = `# Codex Running in Arctic

You are running Codex through Arctic, an open-source terminal coding assistant. Arctic provides different tools but follows Codex operating principles.
...
export interface CodexArcticBridgeMeta {
...
export const CODEX_OPENCODE_BRIDGE_META: CodexArcticBridgeMeta = {
	estimatedTokens: 550,
