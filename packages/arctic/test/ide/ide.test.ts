...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ARCTIC_CALLER", () => {
    process.env["ARCTIC_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ARCTIC_CALLER", () => {
    process.env["ARCTIC_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ARCTIC_CALLER", () => {
    process.env["ARCTIC_CALLER"] = "unknown"
